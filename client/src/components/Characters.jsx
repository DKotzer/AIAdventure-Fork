  ...
  render() {
    ...
    return (
      <div className='container-fluid my-5'>
        ...
        {this.props.isFiltered ? <p className="display-8 text-white" style={{"textAlign":"center"}}>Explore the characters you have created.</p> : <p className="display-8 text-white" style={{"textAlign":"center"}}>Explore characters from around the world.</p>}
